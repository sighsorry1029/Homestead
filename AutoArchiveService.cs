...
internal static class AutoArchiveService
{
    ...
    {
        if (_scanCoroutine != null && HomesteadPlugin.Instance != null)
        {
            HomesteadPlugin.Instance.StopCoroutine(_scanCoroutine);
            _scanCoroutine = null;
        }
    ...
    private static void QueueScan(AutoArchiveScanOptions options)
    {
        ...
        _scanCoroutine = HomesteadPlugin.Instance.StartCoroutine(RunScan(options));
    }
    ...
    {
        return HomesteadPlugin.Instance != null &&
               ZNet.instance != null &&
