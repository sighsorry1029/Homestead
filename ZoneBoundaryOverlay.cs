...
internal static class ZoneBoundaryOverlay
{
    ...
    private static void EnsureLine()
    {
        ...
        _lineRoot = new GameObject("HomesteadZoneBoundary");
    ...
    private static void EnsureHud()
    {
        ...
        _hudText.gameObject.name = "HomesteadZoneHud";
    ...
    private static void UpdateHud(Vector2i zone)
    {
        ...
        _hudText.text = HomesteadLocalization.Format("hs_zone_hud", zone.x, zone.y);
    }
